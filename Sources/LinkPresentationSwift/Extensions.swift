...
extension Error {
    ...
    public static func timeout() -> LinkPresentationSwift.Error {
...
extension Result where Failure == Swift.Error {
    ...
    public func mapNetworkError() -> Result<Success, LinkPresentationSwift.Error> {
        switch self {
...
extension URLRequest {
    ...
    public static func metadataRequest(url: URL, timeout: TimeInterval = 30.0) -> URLRequest {
